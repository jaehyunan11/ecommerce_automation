...
class AddCustomer:
    # Check the xpath once again
    # Add customer Page
    # XPath = //tagname[@Attribute = ‘value’]
    lnkCustomers_menu_xpath = "//a[@href='#']//*[contains(text(), 'Customers')]"
    lnkCustomers_menuitem_xpath = "//ul[@class='nav nav-treeview']//*[contains(text(),'Customers')]"
    btnAddnew_xpath = "//a[@class='btn btn-primary']"
    txtEmail_xpath = "//input[@id='Email']"
    txtPassword_xpath = "//input[@id='Password']"
    # need to check bottom codes !!!!!!
    ...
    def clickOnCustomersMenuItem(self):
        self.driver.find_element_by_xpath(
            self.lnkCustomers_menuitem_xpath).click()
    ...
    def setPassword(self, password):
        self.driver.find_element_by_xpath(
            self.txtPassword_xpath).send_keys(password)
    ...
    def setCustomerRoles(self, role):
        ...
        time.sleep(3)
        # self.listitem.click()
        # Javascript statement of click action
        self.driver.execute_script("arguments[0].click();", self.listitem)

    def setManagerOfVendor(self, value):
        drp = Select(self.driver.find_element_by_xpath(
